...
static PyMethodDef methodsMethods[] = {
    ...
    {"calculate_surface_velocity", py_calculate_surface_velocity, METH_VARARGS,
        ...
        "Two call signatures:\n\n"
        "Signature A — list of EulerVectors, single point:\n"
        "  ev_ensemble : list of EulerVector\n"
        "  lon, lat    : float\n"
        "  Returns a tuple of four 1-D NumPy arrays (east_vel, north_vel,\n"
        "  total_vel in cm/yr; azimuth in degrees CW from North).\n\n"
        "Signature B — single EulerVector, multiple points:\n"
        "  ev          : EulerVector (with or without covariance)\n"
        "  lons, lats  : sequence of float\n"
        ...
        "  Velocity fields are Stat objects when covariance is present, plain\n"
        "  floats otherwise."
    },
